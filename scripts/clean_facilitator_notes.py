...
def clean_child_observation_data_with_llm(input_file='data/raw/raw_observations.txt', output_csv='data/processed/cleaned_observations.csv', output_json='data/processed/cleaned_observations.json'):
    """
    ...
    Parameters:
    -----------
    input_file : str, default='data/raw/raw_observations.txt'
        Path to input CSV/TXT file with raw data
    output_csv : str, default='data/processed/cleaned_observations.csv'
        Path to output CSV file
    output_json : str, default='data/processed/cleaned_observations.json'
